...
export const getPaginatedDocuments = <T>({storeId, page = DEFAULT_PAGE, perPage = DEFAULT_DOCUMENTS_PER_PAGE}: Request<T>) =>  (documentIds: DocumentId[]): EitherAsync<Error, T[]> => {
