...
const getNumberOfItemsInStore = (db) => (storeName) => {
    try {
        ...
        return new Promise((resolve, reject) => {
            ...
            countRequest.onerror = () => { var _a; return reject(new Error('An error occured when getting the number of items of store "${storeName}": ' + ((_a = transaction === null || transaction === void 0 ? void 0 : transaction.error) === null || _a === void 0 ? void 0 : _a.message))); };
        });
    }
    catch (e) {
...
const addDataToStore = (db) => (storeName) => (data) => {
...
const addDataToStore = (storeName) => (data) => {
    const command = db => (0,purify_ts_EitherAsync__WEBPACK_IMPORTED_MODULE_2__.EitherAsync)(() => _indexedDB_api__WEBPACK_IMPORTED_MODULE_0__.addDataToStore(db)(storeName)(data));
...
const getItemsCount = (storeName) => {
    const command = db => (0,purify_ts_EitherAsync__WEBPACK_IMPORTED_MODULE_2__.EitherAsync)(() => _indexedDB_api__WEBPACK_IMPORTED_MODULE_0__.getNumberOfItemsInStore(db)(storeName));
    return execute(command);
};
...
const getItems = (storeName) => (itemIds) => (_apis_storage_util__WEBPACK_IMPORTED_MODULE_1__.getItems(storeName)(itemIds)
    .run()
    .then(eitherValues => (eitherValues.caseOf({
    Left: error => { throw error; },
    Right: ramda__WEBPACK_IMPORTED_MODULE_3__.default
