...
const addDataToStore = (db) => (storeName) => (data) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        transaction.onerror = () => { var _a; return reject(new Error(`An error occured when inserting data for store ${storeName}: ${(_a = transaction === null || transaction === void 0 ? void 0 : transaction.error) === null || _a === void 0 ? void 0 : _a.message}`)); };
    });
};
...
const deleteDatabase = () => (_apis_storage_util__WEBPACK_IMPORTED_MODULE_1__.deleteDatabase()
    .run()
    .then(eitherValues => (eitherValues.caseOf({
    Left: error => { throw error; },
    Right: ramda__WEBPACK_IMPORTED_MODULE_3__.default
