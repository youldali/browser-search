...
const createStore = (storeName) => (simplifiedIndexConfig) => (keyPath) => {
    ...
    return (0,purify_ts_EitherAsync__WEBPACK_IMPORTED_MODULE_2__.EitherAsync)(() => _indexedDB_api__WEBPACK_IMPORTED_MODULE_0__.upgradeDatabase(databaseId)(createObjectStore))
...
const deleteStore = (storeName) => {
    const command = db => purify_ts_EitherAsync__WEBPACK_IMPORTED_MODULE_2__.EitherAsync.liftEither(purify_ts_Either__WEBPACK_IMPORTED_MODULE_4__.Either.encase(() => _indexedDB_api__WEBPACK_IMPORTED_MODULE_0__.deleteObjectStore(storeName)(db)));
