...
const createObjectStore = (storeName) => (indexConfig) => (keyPath) => (dbName) => (upgradeDatabase(dbName)(db => {
...
const createStore = (storeName) => (simplifiedIndexConfig) => (keyPath) => {
    ...
    return (0,purify_ts_EitherAsync__WEBPACK_IMPORTED_MODULE_2__.EitherAsync)(() => _indexedDB_api__WEBPACK_IMPORTED_MODULE_0__.deleteObjectStoreIfExist(storeName)(databaseId))
        .chain(() => (0,purify_ts_EitherAsync__WEBPACK_IMPORTED_MODULE_2__.EitherAsync)(() => _indexedDB_api__WEBPACK_IMPORTED_MODULE_0__.createObjectStore(storeName)(indexConfig)(keyPath)(databaseId)))
...
const deleteStoreIfExist = (storeName) => ((0,purify_ts_EitherAsync__WEBPACK_IMPORTED_MODULE_2__.EitherAsync)((() => _indexedDB_api__WEBPACK_IMPORTED_MODULE_0__.deleteObjectStoreIfExist(storeName)(databaseId))));
