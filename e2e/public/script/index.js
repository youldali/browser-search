...
const getNumberOfItemsInStore = (db) => (storeName) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        countRequest.onerror = () => { var _a; return reject(new Error('An error occured when getting the number of items: ' + ((_a = transaction === null || transaction === void 0 ? void 0 : transaction.error) === null || _a === void 0 ? void 0 : _a.message))); };
    });
};
