...
const getDocuments = (db) => (storeName) => (itemIds) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        transaction.onerror = () => { var _a; return reject(new Error(`An error occured when getting the items of store "${storeName}": ${(_a = transaction === null || transaction === void 0 ? void 0 : transaction.error) === null || _a === void 0 ? void 0 : _a.message}`)); };
    });
};
...
const getDocuments = (storeName) => (itemIds) => {
    const command = db => (0,purify_ts_EitherAsync__WEBPACK_IMPORTED_MODULE_2__.EitherAsync)(() => _indexedDB_api__WEBPACK_IMPORTED_MODULE_0__.getDocuments(db)(storeName)(itemIds));
    return execute(command);
};
...
const addDocumentsToStore = (storeName) => (data) => (_apis_storage_util__WEBPACK_IMPORTED_MODULE_1__.addDocumentsToStore(storeName)(data)
    .run()
    .then(eitherValues => (eitherValues.caseOf({
    Left: error => { throw error; },
    Right: ramda__WEBPACK_IMPORTED_MODULE_3__.default
...
const getDocuments = (storeName) => (itemIds) => (_apis_storage_util__WEBPACK_IMPORTED_MODULE_1__.getDocuments(storeName)(itemIds)
    .run()
    .then(eitherValues => (eitherValues.caseOf({
    Left: error => { throw error; },
    Right: ramda__WEBPACK_IMPORTED_MODULE_3__.default
...
const deleteStoreIfExist = (storeName) => (_apis_storage_util__WEBPACK_IMPORTED_MODULE_1__.deleteStoreIfExist(storeName)
    .run()
    .then(eitherValues => (eitherValues.caseOf({
    Left: error => { throw error; },
    Right: ramda__WEBPACK_IMPORTED_MODULE_3__.default
}))));
const deleteAllStores = () => (_apis_storage_util__WEBPACK_IMPORTED_MODULE_1__.deleteDatabase()
    .run()
    .then(eitherValues => (eitherValues.caseOf({
    Left: error => { throw error; },
    Right: ramda__WEBPACK_IMPORTED_MODULE_3__.default
