...
export declare const getNumberOfItemsInStore: (db: IDBDatabase) => (storeName: string) => Promise<number>;
export declare const addDataToStore: <T>(db: IDBDatabase) => (storeName: string) => (data: T[]) => Promise<IDBDatabase>;
...
export declare const getItems: <T>(db: IDBDatabase) => (storeName: string) => (itemIds: IDBValidKey[]) => Promise<T[]>;
