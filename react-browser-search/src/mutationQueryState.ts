...
export type MutationQueryState<Request, Response, Error> = MutationIdleState | MutationLoadingQueryState<Request> | MutationSuccessQueryState<Request, Response> | MutationErrorQueryState<Request, Error>;
